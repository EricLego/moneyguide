        ...
        <div className="card">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <button 
              ...
              className="w-full py-2 px-4 border border-transparent text-sm font-medium rounded-md text-primary-dark bg-primary/10 hover:bg-primary/20 transition-colors mb-4 flex items-center justify-center shadow-sm"
            >
